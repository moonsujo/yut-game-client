...
export default function Alert({ position, rotation }) {
    ...
    >
      ...
      <TurnAlertGame/>
      <GameStartAlert/>
      <PregameTieAlert scale={springs.pregameTieAlertScale} rotation={[0, Math.PI/2, 0]}/>
      <PregameRocketsWinAlert scale={springs.pregameRocketsWinAlertScale} rotation={[0, Math.PI/2, 0]}/>
      <PregameUfosWinAlert scale={springs.pregameUfosWinAlertScale} rotation={[0, Math.PI/2, 0]}/>
      <YootOutcome1Alert/>
      <YootOutcome2Alert/>
      <YootOutcome3Alert/>
