...
import FragmentShader from '../shader/blueMoonBright/fragment.glsl'
import VertexShader from '../shader/blueMoonBright/vertex.glsl'
import { useFrame } from "@react-three/fiber";
import { useAtom, useSetAtom } from "jotai";
import { blueMoonBrightnessAtom } from "../GlobalState";
import { lerp } from "three/src/math/MathUtils.js";

export default function BlueMoonBright({ position=[0,0,0], rotation=[0,0,0], scale=1, rotationSpeed=0.1 }) {
  ...
  const uniforms = useMemo(() => ({
    uSunDirection: { value: new THREE.Vector3(0,5,0) },
    uMoonTexture: { value: moonTexture },
    uAtmosphereDayColor: { value: new THREE.Color('#5b83c8') },
    uAtmosphereTwilightColor: { value: new THREE.Color('#2067b9') },
    uAtmosphereColorFactor: { value: 1.0 }
  }), []);
