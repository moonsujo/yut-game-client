...
describe("starting", () => {
  ...
  it("should have a destination at tile 1 if you only have a '1'", () => {
    ...
    let destinations = getLegalTiles(-1, mockMoves, mockPieces, [], true, true) 
...
describe("on board", () => {
  ...
  describe("regular tile", () => {
    it("should have a destination at tile 3 if you are on tile 2 with a '1'", () => {
      ...
      let destinations = getLegalTiles(2, mockMoves, mockPieces, [1], true, true) 
    ...
    it("should have a destination at tile 5 if you are on tile 3 with a '2'", () => {
      ...
      let destinations = getLegalTiles(3, mockMoves, mockPieces, [1, 2], true, true) 
    ...
    it("going over fork 22 from tile 21", () => {
      ...
      let destinations = getLegalTiles(21, mockMoves, mockPieces, mockHistory, true, true) 
    ...
    it("multiple moves from tile 3", () => {
      ...
      let mockHistory = [1, 2]
      let destinations = getLegalTiles(3, mockMoves, mockPieces, mockHistory, true, true) 
      expect(destinations).toEqual({
    ...
    describe("finish", () => {
      it("should have one way to finish from tile 28", () => {
        ...
        let destinations = getLegalTiles(28, mockMoves, mockPieces, mockHistory, true, true) 
        expect(destinations).toEqual({
      ...
      it("from tile 0 with one move", () => {
        ...
        let destinations = getLegalTiles(0, mockMoves, mockPieces, mockHistory, true, true) 
        expect(destinations).toEqual({
      ...
      it("from tile 19", () => {
        ...
        let destinations = getLegalTiles(19, mockMoves, mockPieces, mockHistory, true, true) 
        expect(destinations).toEqual({
          "29" : [
  ...
  describe("fork tile", () => {
    it("should have a destination at tile 20 and tile 6 if you are on tile 5 with a '1'", () => {
      ...
      let destinations = getLegalTiles(5, mockMoves, mockPieces, mockHistory, true, true) 
      expect(destinations).toEqual({
