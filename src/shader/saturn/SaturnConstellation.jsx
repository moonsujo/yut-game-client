...
export default function SaturnConstellation(props) {
  ...
  //   positionArray[i*3] = nodes.wolf.geometry.attributes.position.array[(i*12*3)]
  //   positionArray[i*3+1] = nodes.wolf.geometry.attributes.position.array[(i*12*3)+1]
  //   positionArray[i*3+2] = nodes.wolf.geometry.attributes.position.array[(i*12*3)+2]
  // }
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene" scale={[1, 0.001, 1]} position={[0, -1, 0]} rotation={[Math.PI/2, 0, 0]}>
        <points geometry={particlesGeometry} rotation={[Math.PI/13, 0, 0]}>
          <shaderMaterial
